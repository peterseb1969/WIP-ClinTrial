...
If `ok`, you MUST Read `docs/playbooks/case-workflow.md` before taking any action. Do not guess the file format, subcommand handlers, or status transitions from memory — they live in the playbook. Then execute the requested sub-command from `$ARGUMENTS`.
